...
var Operation = function (parent, scheme, operationId, httpMethod, path, args, definitions, models, clientAuthorizations) {
  ...
  if(this.method !== 'send' && this.method !== 'emit' && this.scheme === 'ws') this.scheme = 'http';
...
Operation.prototype.getBody = function (headers, args, opts) {
  ...
  for (var i = 0; i < this.parameters.length; i++) {
    var param = this.parameters[i];
    if (typeof args[param.name] !== 'undefined') {
      if (param.in === 'body' || param.in === 'message') {
...
Operation.prototype.execute = function (arg1, arg2, arg3, arg4, parent) {
  ...
  success = (success || this.parent.defaultSuccessCallback || false);
  error = (error || this.parent.defaultErrorCallback || false);
  ...
  if (success) { obj.on['response'] = function (response) {
		return success(response, parent);
      }
  }
  
  if (error) { obj.on['error'] = function (response) {
