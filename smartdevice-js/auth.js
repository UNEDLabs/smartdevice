// require: btoa, cookiejar, lodash

/**
 * SwaggerAuthorizations applys the correct authorization to an operation being executed
 */
var SwaggerAuthorizations = function (authz) {
  this.authz = authz || {};
};
 ...
 */
var PasswordAuthorization = function (username, password) {
  if (arguments.length === 3) {
    console.log('PasswordAuthorization: the \'name\' argument has been removed, pass only username and password');
